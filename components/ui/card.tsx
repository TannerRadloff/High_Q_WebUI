...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-lg border border-border/40 bg-card/90 backdrop-blur-sm text-card-foreground shadow-md hover:shadow-[0_0_15px_rgba(0,150,255,0.15)] transition-shadow duration-300',
      className,
    )}
    {...props}
  />
