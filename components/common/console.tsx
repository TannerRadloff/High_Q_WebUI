import { TerminalWindowIcon, LoaderIcon, CrossSmallIcon } from '@/src/components/common/icons';
    ...
    <>
      ...
      >
        <div className="flex flex-row justify-between items-center w-full h-fit border-b dark:border-zinc-700 border-zinc-200 px-2 py-1 sticky top-0 z-50 bg-muted">
          ...
          <Button
            variant="ghost"
            className="size-fit p-1 hover:bg-primary/10 hover:text-primary rounded-md"
            size="icon"
