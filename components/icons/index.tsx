...
// Create simple icon components that mimic the Lucide icons
...
export const LoaderIcon = ({ className, size = 16 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const FullscreenIcon = ({ className, size = 16 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Additional icons needed for sidebar-history.tsx
...
export const CheckCircleFillIcon = ({ className, size = 16 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Simple icon components with consistent API
...
export const GitBranch: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
